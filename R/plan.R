plan = drake_plan(
  orig_all = read_rds("data/all-ngsschat-tweets.rds"),
  users = read_csv("data/users-to-analyze.csv"),
  orig = read_rds("data/ngsschat-tweets-14-15.rds"),
  orig_pre = read_csv("data/orig-pre-14.csv"),
  orig_post = read_csv("data/orig-post-15.csv"),
  edge = read_csv("data/edgelist-to-analyze.csv"),
  state_data = read_excel("data/state-data.xlsx"),
  l = read_rds("data/geocoded-locations.rds"),
  coded_threads = read_csv("data/qual-coded-tweets.csv"),
